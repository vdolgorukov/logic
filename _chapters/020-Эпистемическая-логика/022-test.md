...
**Упражнение 2**. Постройте отмеченные эпистемические модели для следующих формул (или докажите, что это невозможно): 
1. $$\neg K_a p \wedge K_b p $$
2. $$\neg K_a p \wedge p $$ 
3. $$ K_a p \wedge \neg p $$
4. $$ \hat{K}_a p \wedge \neg p $$
5. $$K_a p \wedge (p \to \psi) \wedge \neg K_a \psi $$
6. $$K_a p \wedge K_a ( p \to \psi) \wedge \neg K_a\psi $$ 
7. $$ \hat{K}_a p \wedge \hat{K}_a \neg p $$
8. $$ K_a K_b p \wedge \neg K_a p$$
9. $$ K_a K_b p \wedge \neg K_b K_a p $$
10. $$ K_b K_a p \wedge K_a K_b p \wedge \neg K_a K_b K_a p $$
11. $$E_{ab}p \wedge K_a K_b p \wedge \neg K_b K_a p$$	
12. $$E_{ab}p \wedge \neg K_a K_b p \wedge \neg K_b K_a p$$
13. $$E^2_{ab}p \wedge K_a K_b K_a p \wedge \neg K_b K_a K_b p $$
14. $$E^2_{ab}p \wedge \neg K_a K_b K_a p \wedge \neg K_b K_a K_b p $$

**Упражнение 3**. Постройте эпистемические модели, которые бы описывали следующую ситуацию:
