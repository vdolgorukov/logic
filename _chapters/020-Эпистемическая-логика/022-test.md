...
**Упражнение 3**. Постройте отмеченные эпистемические модели для следующих формул (или докажите, что это невозможно): 
...
**Упражнение 4**. Постройте эпистемические модели, которые бы описывали следующую ситуацию:
